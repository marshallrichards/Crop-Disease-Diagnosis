...
# v1.0 using subprocess to run the tensorflow 2.7 script and allow flask to be run in 3.5
# Next version will be running fully 3.5 with tensorflow script written in 3.5
# and not reliant on text io for decision making, it will be integrated so that
# an outside file('info.txt') is not needed
# Also, next version will allow for more than one user request at a time but that may require
# abandoning of flask
import os
import sys
import shutil
